...
def background(ax, label, xticks=0, yticks=0):
    ax.text(0.5, 1.08, label, va='center', ha='center', size=9, color='black', transform=ax.transAxes)
...
plt.legend(sorted_plots, sorted_labels, loc='center left', bbox_to_anchor=(1.04, 1.7), title='City', prop={'size': 10})
